...
def main():
    ...
    if system_name == UBUNTU:
        ...
        card_type = int(input("What NVIDIA card do you have?:\n Type 1, for recent GeForce/Quadro/Tesla\n Type 2 for legacy GeForce 400/500 \n Type 3 for Legacy GeForce 8/9/200/300"))
        #Driver instalation
        ...
        execute_shell_command(["echo", "add_drivers+=\"nvidia nvidia_modeset nvidia_uvm nvidia_drm\"\ninstall_items+=\"/etc/modprobe.d/nvidia.conf\"", ">>", "/etc/dracut.conf.d/nvidia.conf"])
